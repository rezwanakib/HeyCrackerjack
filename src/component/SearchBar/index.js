...
import {Box,Button,Select,makeStyles, MenuItem,CircularProgress} from '@material-ui/core';
...
const handleChange = e => {
    ...
    return(
        <Box p={2} mb={2} className={classes.wrapper} >
            ...
            <Button disabled= {loading} variant="contained" color="primary" disableElevation
            onClick={search}
            >
            {loading ? (

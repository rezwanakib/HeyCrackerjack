        ...
        <Dialog open={props.newJobModal} fullWidth>
            ...
            <DialogContent>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={6}>
                        <FilledInput onChange={handleChange} name="companyLink" value={jobDetails.companyLink} autoComplete="off" placeholder="Company Link" disableUnderline fullWidth />
                    </Grid>

                    <Grid item xs={6}>
                        <FilledInput onChange={handleChange} name="jobLink" value={jobDetails.jobLink} autoComplete="off" placeholder="Job Link*" disableUnderline fullWidth />

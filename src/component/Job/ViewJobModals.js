    ...
    <Dialog open={!!Object.keys(props.job).length} fullWidth> 
        <DialogTitle>
            ...
            <DialogContent>
                ...
                <Box className={classes.info} display="flex">
                    ...
                    <Typography variant="body2">
                         { props.job.postedOn && format(props.job.postedOn,"dd/MMM/yyy HH:MM")}
                    </Typography>
                </Box>
            ...
            <DialogActions>
                ...
                <Button variant="outlined" component="a" href={props.job.jobLink} target="_blank">
                            Apply
                </Button>
